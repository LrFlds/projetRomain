...
function addNewInput(id){
    ...
    document.querySelectorAll('.tooltip')[id- 1].classList.add("apear");
    setTimeout( function back(){
    document.querySelectorAll('.tooltip')[id- 1].classList.remove("apear");
    }, 1500);
...
let audio = new Audio('imgs/quack.mp3');
